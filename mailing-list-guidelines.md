# `agentproto` Mailing List Discussion Guidelines

For **`agentproto@ietf.org`** ([archive](https://mailarchive.ietf.org/arch/browse/agentproto)).
...
Posts relate to the posted agenda or to the BOF's purpose, and the chairs defer or reject messages that do not.
...
- **Read first.** Read the archive and the relevant documents before you post (RFC 7154 §2).
- **Be brief.** Keep messages short and on topic (RFC 1855 §3.1.1).
- **Plain text.** Send plain text only, with no HTML-only mail and no unnecessary attachments.
...
4. **Meta-discussion.** Do not start threads here about this policy.
   The community-wide discussion is on `ietf@ietf.org` ([archive](https://mailarchive.ietf.org/arch/browse/ietf/)), in the thread "Dealing with LLMs in IETF discussions".
   Moderation-policy discussion also has an official designated forum, `mod-discuss@ietf.org` ([archive](https://mailarchive.ietf.org/arch/browse/mod-discuss/)), for community moderation under RFC 9945.
   Before raising it on any other list, ask that list's chairs whether the topic is on their agenda.
...
- Length, headings, or bullets out of proportion to the point.
- Empty praise of the message being answered.
- A guess at what an ambiguous message meant, in place of a request for clarification.
- Drift toward agreement with whoever spoke last, or more hedging than you intend.
- Wrong details, including citations that do not say what is claimed.
...
- Active voice and common words.
- The same word for the same concept, every time.

The standard is a free direct download: [ASD-STE100 Issue 9](https://www.asd-ste100.org/assets/files/ASD-STE100_ISSUE9.pdf).
Part 1 holds the writing rules and Part 2 the dictionary of approved words.
Link to it rather than reposting it, because ASD restricts reproduction.
